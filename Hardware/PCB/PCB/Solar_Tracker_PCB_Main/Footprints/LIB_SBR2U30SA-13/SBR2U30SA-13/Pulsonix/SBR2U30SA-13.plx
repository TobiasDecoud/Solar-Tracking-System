...
//1415560/1905874/2.50/2/3/Diode
...
(library Library_1
	...
	(symbolDef "SBR2U30SA-13" (originalName "SBR2U30SA-13")
	...
	(compDef "SBR2U30SA-13" (originalName "SBR2U30SA-13") (compHeader (numPins 2) (numParts 1) (refDesPrefix D)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "SBR2U30SA-13"))
		...
		(attr "Mouser Part Number" "621-SBR2U30SA-13")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Diodes-Incorporated/SBR2U30SA-13?qs=oUsD4qhOtFzn2RwqTbZr%252Bw%3D%3D")
		(attr "Manufacturer_Name" "Diodes Incorporated")
		(attr "Manufacturer_Part_Number" "SBR2U30SA-13")
		(attr "Description" "Rectifier Diode Super Barrier Rectifier 30V 2A 2-Pin SMA T/R")
		(attr "<Hyperlink>" "https://www.diodes.com/assets/Datasheets/SBR2U30SA.pdf")
		(attr "<Component Height>" "2.3")
		(attr "<STEP Filename>" "SBR2U30SA-13.stp")
